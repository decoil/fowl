/// <summary>
/// Fowl SIMD - Hardware-Specific Intrinsics Wrapper
/// </summary>
/// <remarks>
...
/// <summary>
/// Print hardware SIMD detection information.
/// </summary>
let printHardwareInfo () : unit =
...
/// <summary>
/// Add two arrays using best available hardware instructions.
/// </summary>
...
/// <summary>
/// Subtract two arrays using best available hardware instructions.
/// </summary>
...
/// <summary>
/// Multiply two arrays using best available hardware instructions.
/// </summary>
/// <param name="a">First array.</param>
/// <param name="b">Second array.</param>
...
/// <summary>
/// Divide two arrays using best available hardware instructions.
/// </summary>
/// <param name="a">First array (dividend).</param>
/// <param name="b">Second array (divisor).</param>
/// <returns>New array with element-wise quotient.</returns>
...
/// <summary>
/// Add scalar to each element using hardware instructions.
/// </summary>
...
/// <summary>
/// Multiply each element by scalar using hardware instructions.
/// </summary>
/// <param name="a">Input array.</param>
...
/// <summary>
/// Negate all elements using hardware instructions.
/// </summary>
/// <param name="a">Input array.</param>
...
/// <summary>
/// Add two float arrays using best available hardware instructions.
/// </summary>
/// <param name="a">First array.</param>
/// <param name="b">Second array.</param>
/// <returns>New array with element-wise sum.</returns>
...
/// <summary>
/// Multiply two float arrays using best available hardware instructions.
/// </summary>
/// <param name="a">First array.</param>
/// <param name="b">Second array.</param>
/// <returns>New array with element-wise product.</returns>
...
/// <summary>
/// Sum all elements using best available hardware instructions.
/// </summary>
/// <param name="a">Input array.</param>
...
/// <summary>
/// Calculate mean using hardware instructions.
/// </summary>
/// <param name="a">Input array.</param>
...
/// <summary>
/// Dot product using best available hardware instructions.
/// </summary>
/// <param name="a">First array.</param>
/// <param name="b">Second array.</param>
...
/// <summary>
/// Find minimum element using hardware instructions.
/// </summary>
/// <param name="a">Input array.</param>
...
/// <summary>
/// Find maximum element using hardware instructions.
/// </summary>
/// <param name="a">Input array.</param>
...
/// <summary>
/// Add arrays in-place using hardware instructions.
/// </summary>
/// <param name="result">Array to modify in place (also holds result).</param>
...
/// <summary>
/// Multiply array by scalar in-place using hardware instructions.
/// </summary>
/// <param name="result">Array to modify in place.</param>
/// <param name="scalar">Value to multiply.</param>
...
let performanceComparison (size: int) : unit =
