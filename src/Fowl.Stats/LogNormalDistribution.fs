...
/// </summary>
module LogNormalDistribution =
    
    /// <summary>Validate Log-Normal parameters.
/// </summary>
    let private validate (mu: float) (sigma: float) : FowlResult<unit> =
        if sigma <= 0.0 then
...
/// </summary>
    let rvs (mu: float) (sigma: float) (seed: int option) : FowlResult<float> =
        result {
            do! validate mu sigma
...
/// </summary>
    let mean (mu: float) (sigma: float) : FowlResult<float> =
        result {
            do! validate mu sigma
...
/// </summary>
    let variance (mu: float) (sigma: float) : FowlResult<float> =
        result {
            do! validate mu sigma
...
/// </summary>
    let std (mu: float) (sigma: float) : FowlResult<float> =
        result {
...
/// </summary>
    let mode (mu: float) (sigma: float) : FowlResult<float> =
        result {
            do! validate mu sigma
...
/// </summary>
    let median (mu: float) (sigma: float) : FowlResult<float> =
        result {
            do! validate mu sigma
            return exp mu
        }
...
/// </summary>
    let skewness (mu: float) (sigma: float) : FowlResult<float> =
        result {
            do! validate mu sigma
            let sigma2 = sigma * sigma
            let es2 = exp sigma2
...
/// </summary>
    let kurtosisExcess (mu: float) (sigma: float) : FowlResult<float> =
        result {
            do! validate mu sigma
            let sigma2 = sigma * sigma
            let es2 = exp sigma2
...
/// </summary>
    let entropy (mu: float) (sigma: float) : FowlResult<float> =
        result {
            do! validate mu sigma
